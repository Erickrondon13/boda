...
function renderGuestInfo(guest) {
    ...
    guestWelcome.textContent = `Te invitamos a nuestra boda civil, ${guest.nombre_apellido}`;
        ...
        try {
            ...
            const { error } = await supabaseClient
                ...
                .update({
                    ...
                    civil_cantidad_confirmada: cantidadConfirmada,
                    civil_fecha_confirmacion: now,
